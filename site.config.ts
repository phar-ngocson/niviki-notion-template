...
export default siteConfig({
  ...
  name: 'Chuyện sao Hoả',
  domain: 'nguyenngocson.id.vn',
  author: 'NgocSon',

  // open graph metadata (optional)
  description: 'Thực ra tôi đến từ sao Hoả, bạn đến từ sao Kim. Chúng ta cùng sống trên Trái Đất',
  ...
  facebook: 'https://www.facebook.com/ChuyensaoHoa',
